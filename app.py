...
st.set_page_config(page_title="MathGPT", page_icon="✖️")
st.title("Text To Math Problem Solver using Google Gemma 2")

# LLM
llm=ChatGroq(model="Gemma2-9b-It")

## Initializing the Wiki Tool
...
# Prompt
prompt="""
Your are an agent tasked for solving users mathematical question. Logically arrive at the solution and provide a detailed explanation
